...
public class RSA {
    ...
    public static byte[] MEURETORNO;
    public static String MEURETORNO2;
    ...
    /**
     * Local das chaves privada e pública no sistema de arquivos.
     */
    public static final String PATH_CHAVE_PRIVADA = PASTA_USUARIO + BARRA + "seginfo" + BARRA + "keys" + BARRA + "chavePrivada.key";

    public static final String PATH_CHAVE_PUBLICA = PASTA_USUARIO + BARRA + "seginfo" + BARRA + "keys" + BARRA + "chavePublica.key";
